 ...
 */
@Api(tag = IdeaController.TAG, description = "获取idea激活码")
public class IdeaController extends BaseController {

    protected static final String TAG = "IDEA";
    ...
    @Override
    @ApiOperation(url = "/idea/", tag = IdeaController.TAG, httpMethod = HttpMethod.GET, description = "获取idea激活码")
    public void index() {
        renderJson(ideaService.getListCode(DEFAULT_FILTER, DEFAULT_KEY));
    }

    @ApiOperation(url = "/idea/filter", tag = IdeaController.TAG, httpMethod = HttpMethod.GET, description = "获取idea激活码")
    @Params({
    ...
    @ApiOperation(url = "/idea/getCodeFile", tag = IdeaController.TAG, httpMethod = HttpMethod.GET, description = "获取idea激活码文件")
    public void getCodeFile() {
        redirect(JIHUOMA_ZIP);
    }

    @ApiOperation(url = "/idea/medeming", tag = IdeaController.TAG, httpMethod = HttpMethod.GET, description = "获取idea激活码by - medeming")
    @Param(name = "filter", description = "过滤条件", defaultValue = DEFAULT_FILTER)
    ...
    @ApiOperation(url = "/idea/lookdiv", tag = IdeaController.TAG, httpMethod = HttpMethod.GET, description = "获取idea激活码by - lookdiv")
    @Param(name = "key", description = "关键字", defaultValue = DEFAULT_KEY)
