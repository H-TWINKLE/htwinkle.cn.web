...
public interface Constant {
	...
	public final static String jwglHome = "http://jwgl.cdnu.edu.cn/default2.aspx";
	...
	public final static String eolLogin = "http://eol.cdnu.edu.cn/eol/homepage/common/login.jsp";
	public final static String eolindex = "http://eol.cdnu.edu.cn/eol/homepage/common/index.jsp";

	public final static int FAILURE = 10001; // 登录失败，用户或者密码错误，或者验证码错误。
	public final static int SUCCESS = 10000; // 登录成功
	public final static int NETFAILURE = 10002; // 网络异常 内部异常
	public final static int SERVERERROR = 10003; // host错误 服务器不存在
	public final static int NEVERTOENAL = 10004; // 没有进行系统评价；

	public final static String FAILURESERVER = "服务器错误";

	public final static String eolStudentIndex = "http://eol.cdnu.edu.cn/eol/welcomepage/student/index.jsp";
	public final static String eolTask = "http://eol.cdnu.edu.cn/eol/common/hw/student/hwtask.jsp";
